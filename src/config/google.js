...
export const SPREADSHEET_ID = '18p6GZI13OgUssecIH21PjPvApTAa9VOWnEHGYfp9EEs';

// Configuración adicional
export const SHEET_NAME = 'Incidentes'; // Nombre de la hoja donde guardaremos los datos

// Discovery docs para la API de Google Sheets
